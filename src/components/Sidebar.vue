    ...
    <div class="sidebar-wrapper active">
      ...
      <div class="sidebar-menu">
        <ul class="menu">
          ...
          <li class="sidebar-item" :class="$route.name == 'dashboard' ? 'active' : ''">
          ...
          <li class="sidebar-item has-sub">
            ...
            <ul class="submenu">
              <li class="submenu-item" :class="$route.name == 'produk' ? 'active' : ''">
                <RouterLink :to="{ name: 'produk' }" class="submenu-link">
                  Data Produk
                </RouterLink>
              </li>
          ...
          <li class="sidebar-item" :class="$route.name == 'proses-apriori' ? 'active' : ''">
            <RouterLink :to="{ name: 'proses-apriori' }" class="sidebar-link">
